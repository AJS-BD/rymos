      ...
      <section className="py-16 sm:py-24 lg:py-32">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 xl:gap-20 items-center">
            <FadeInWhenVisible>
              <div
                className="aspect-[4/3] rounded-2xl sm:rounded-3xl overflow-hidden relative bg-cover bg-center bg-no-repeat"
            ...
            <FadeInWhenVisible delay={0.2}>
              <div className="mt-6 lg:mt-0 text-center lg:text-left">
                ...
                <Link
                  href="/products"
                  className="inline-flex items-center gap-1 mt-6 sm:mt-8 text-blue-600 text-sm sm:text-base lg:text-lg hover:underline"
                >
              ...
              <FadeInWhenVisible key={p.id} delay={idx * 0.1}>
                ...
                >
                  <div className="aspect-square bg-white rounded-2xl sm:rounded-3xl overflow-hidden relative shadow-sm">
                    <img
                      src={p.images?.[0] || "https://images.unsplash.com/photo-1511707171634-5f897ff02aa9?w=400&q=80"}
                      alt={p.name}
                      className="absolute inset-0 w-full h-full object-cover group-hover:scale-105 transition-transform duration-500"
                    />
                  </div>
                  <h3 className="mt-4 text-sm sm:text-base font-medium text-gray-900 group-hover:text-blue-600 transition-colors">
                    {p.name}
                  </h3>
